...
export const PostExpanded = () => {
  return (
    <div className="w-full   lg:bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
      <div className="">
        ...
        <p className="text-grey-darker text-base overflow-hidden">
